    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3 col-xs-12">
                <form action="<?=base_url('homecontroller/resetpassword/'.$email)?>" method="post">
                        ...
                        <div class="row">
                         <div class="col-md-12 col-12 mb--15">
                                ...
                                <input class="mb-0 form-control" type="text" name="password"
                                    id="email1" placeholder="Enter new password...">
                                     <?php echo form_error('password');?>
                            </div>
                             <div class="col-md-12 col-12 mb--15">
                                <label for="email">Confirm New Password</label>
                                <input class="mb-0 form-control" type="text" name="cpassword"
                                    id="email1" placeholder="Confirm new password...">
                     ...
                     <div class="col-12 mb--20">
                            ...
                            <div class="col-md-10 offset-lg-1 mb--30">
                                <button type="submit" class="btn btn-outlined" style="width:100%!important;">Reset </button>
                            </div>
                            <div class="col-md-12">
