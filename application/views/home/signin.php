    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3 col-xs-12">
                <form action="<?=base_url('homecontroller/signin')?>" method="post">
                      <div class="login-form shadow ">
                        <?=$this->session->flashdata('message')?>
                        <h2 class="text-center"><span class="font-weight-bold">Login Form</span></h2>

                        <div class="row">
                         <div class="col-md-12 col-12 mb--15">
                                <label for="email">Enter your email / Mobile</label>
                                <input class="mb-0 form-control" type="text" name="lemail"
                                    id="email1" placeholder="Enter you email address here...">
                                     <?php echo form_error('lemail');?>
                            </div>
                                                        <div class="col-12 mb--20">
                                <label for="password">Password</label>
                                <input class="mb-0 form-control" type="password" name="lpassword"
                                    id="login-password" placeholder="Enter your password">
                                     <?php echo form_error('lpassword');?>
                            </div>
                            <?php if($this->session->flashdata('message')!=''){?>
                            <div class="col-md-12 col-12 mb--15"> <a href="<?=base_url('homecontroller/forgetpassword')?>" class="text-info"> forget password ?</a></div>
                            
                            <?php } ?>
                            <div class="col-md-10 offset-lg-1 mb--30">
                                <button type="submit" class="btn btn-outlined" style="width:100%!important;">Login</button>
                            </div>
                            <div class="col-md-12">
                                <span> Not register yet? <a href="<?=base_url('signup')?>"class="text-info"> Create an account</a></span>
