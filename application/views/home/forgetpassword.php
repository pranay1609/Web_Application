    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3 col-xs-12">
                <form action="<?=base_url('homecontroller/forgetpassword')?>" method="post">
                      <div class="login-form shadow ">
                        <?=$this->session->flashdata('message')?>
                        <h2 class="text-center"><span class="font-weight-bold">Reset  Password</span></h2>

                        <div class="row">
                         <div class="col-md-12 col-12 mb--15">
                                <label for="email">Enter your email / Mobile</label>
                                <input class="mb-0 form-control" type="text" name="email"
                            ...
                            <div class="col-md-10 offset-lg-1 mb--30">
                                <button type="submit" class="btn btn-outlined" style="width:100%!important;">Send OTP </button>
                            </div>
                            <div class="col-md-12">
