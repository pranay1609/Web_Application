					    ...
					    <div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
									<form action="<?=base_url('index.php/blog/addblogs')?>" method="POST" enctype="multipart/form-data">
							...
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?=base_url("index.php/blog/update/".$value->id)?>" class="btn "> <i class="bx bx-pencil"></i> </a>
											<a href="<?=base_url("index.php/blog/delete/".$value->id)?>" class="btn btn"> <i class="bx bx-trash"></i> </a>
										</td>
									</tr>
								<?php endforeach ?>
